...
inicio:-
	new(Menu, dialog('Proyecto SDM v1.0 para PLF ITESCAM-ISC-8A', size(1000,800))),
	new(L,label(nombre,'SISTEMA DE DIAGNOSTICO MEDICO')),
	new(A,label(nombre,'By Jayro Salazar | 5871')),
	new(@texto,label(nombre,'responde un breve cuestionario para saber si presenta los sintoma Varicela, Paperas, Hepatitis B, Hepatitis C, Sarampion, Anemia, Resfriado o Influeza.')),
